...
<html>
    ...
    <link rel="stylesheet" href="../css/Masala Powders.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Masala Powders.php../html/Groceries & Vegetables.php">Masala Powders</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Masala Powder/1.jpeg" width="300" height="350">
            <font color="red"> <h1>AACHI BIRYANI MASALA 50 GMS</h1> </font>
            <h2>&#x20B9; 41.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Masala Powder/2.jpeg" width="300" height="350">
              <font color="red"> <h1>AACHI BUTTER MILK KULAMBU MASALA 50 GMS</h1> </font>
              <h2>&#x20B9; 32.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Masala Powder/3.jpeg" width="300" height="350">
              <font color="red"> <h1>AACHI CHICKEN 65 MASALA 50 GMS</h1> </font>
              <h2>&#x20B9; 25.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="row">
            <div class="column">
              <div class="card">
                 <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Masala Powder/4.jpeg" width="300" height="350">
                <font color="red"> <h1>AACHI CHICKEN MASALA 50 GMS</h1> </font>
                <h2>&#x20B9; 23.00</h2>
                <br>
              <p><button>Add to Cart</button></p>
                </div>
            ...
            <div class="column">
              <div class="card">
                  <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Masala Powder/5.jpeg" width="300" height="350">
                  <font color="red"> <h1>AACHI CHILLI CHICKEN MASALA 50 GMS</h1> </font>
                  <h2>&#x20B9; 25.00</h2>
                  <br>
              <p><button>Add to Cart</button></p>
                </div>
            ...
            <div class="column">
              <div class="card">
                  <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Masala Powder/6.jpeg" width="300" height="350">
                  <font color="red"> <h1>AACHI CURRY MASALA 50 GMS</h1> </font>
                  <h2>&#x20B9; 25.00</h2>
                  <br>
              <p><button>Add to Cart</button></p>
                </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Masala Powder/7.jpeg" width="300" height="350">
            <font color="red"> <h1>AACHI EGG CURRY MASALA 50 GMS</h1> </font>
            <h2>&#x20B9; 29.00</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Masala Powder/8.jpeg" width="300" height="350">
              <font color="red"> <h1>AACHI FISH FRY MASALA 50 GMS</h1> </font>
              <h2>&#x20B9; 24.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Masala Powder/9.png" width="300" height="350">
              <font color="red"> <h1>AACHI GARAM MASALA 50 GMS</h1> </font>
              <h2>&#x20B9; 28.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="box">
                <img src="..t/Images/title.jpg" alt="Flowers in Chania">
                  <p>newsletter</p>
