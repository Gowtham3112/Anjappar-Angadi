...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/1.jpeg" width="450" height="350"></a>
            <font color="red"> <h1>1 LITERE BISLERI</h1> </font>
            <h2>&#x20B9; 18.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/2.jpeg" width="390" height="350">
              <font color="red"> <h1>2 LITERE BISLERI</h1> </font>
              <h2>&#x20B9; 28.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/3.jpeg" width="390" height="350">
              <font color="red"> <h1>5 LITERE BISLERI</h1> </font>
              <h2>&#x20B9; 68.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/4.jpeg" width="390" height="350"></a>
            <font color="red"> <h1>500 ML BISLERI</h1> </font>
            <h2>&#x20B9; 9.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/5.jpeg" width="390" height="350">
              <font color="red"> <h1>AQUAFINA 1 LITTER</h1> </font>
              <h2>&#x20B9; 19.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/6.jpeg" width="390" height="350">
              <font color="red"> <h1>AYUR ROSE WATER 120ML</h1> </font>
              <h2>&#x20B9; 39.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/7.jpeg" width="390" height="350"></a>
            <font color="red"> <h1>BISLERI 10 LITER</h1> </font>
            <h2>&#x20B9; 108.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/8.jpeg" width="309" height="350">
              <font color="red"> <h1>BISLERI CLUB SODA</h1> </font>
              <h2>&#x20B9; 17.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/9.jpeg" width="390" height="350">
              <font color="red"> <h1>KARA COCO WATER 250ML</h1> </font>
              <h2>&#x20B9; 58.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Snacks & Beverages/Water/10.jpeg" width="390" height="300"></a>
            <font color="red"> <h1>AQUAFINA 500ML</h1> </font>
            <h2>&#x20B9; 10.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
