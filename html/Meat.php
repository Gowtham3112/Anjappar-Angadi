...
<div class="column1">
    <div class="card1">
      <a href="../html/Raw Meats.php">
      <h3 style="color:rgb(223, 16, 16);">Raw Meats</h3></a>
  ...
  <div class="column1">
    <div class="card1" >
      <a href="../html/Marinated Meats.php">
      <h3 style="color:rgb(223, 16, 16);">Marinated Meats</h3></a>
  ...
  <div class="column1">
    <div class="card1">
      <a href="../html/Fresh Water Fish.php">
      <h3 style="color:rgb(223, 16, 16);">Fresh Water Fish</h3></a>
  ...
  <div class="row">
    <div class="column">
      <div class="card">
        <a href="../html/Raw Meats.php">
          <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats.jpeg" width="390" height="250"></a>
      </div>
    </div>
    ...
    <div class="column">
      <div class="card">
        <a href="../html/Marinated Meats.php">
          <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats.jpeg" width="390" height="250"></a>
      </div>
    </div>
    ...
    <div class="column">
      <div class="card">
        <a href="../html/Fresh Water Fish.php">
          <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Fresh Water Fish.jpeg" width="390" height="250"></a>
      </div>
    </div>
  </div>
</div>  
