...
<html>
    <head>
    <title>Hair Oil & Coconut Oil</title>
    ...
    <link rel="stylesheet" href="../css/Hair Oil & Coconut Oil.css">
    ...
    <div class="header-3">
        <nav class="navbar">
          <a href="../html/Hair Oil & Coconut Oil.php">Hair Oil & Coconut Oil</a>
        </nav>
      </div>
      </header>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Hair Oil & Coconut Oil/1.jpeg" width="300" height="350"></a>
            <font color="red"> <h1>KPL SHUDHI COCONUT OIL 1 LTR</h1> </font>
            <h2>&#x20B9; 238.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Hair Oil & Coconut Oil/2.jpeg" width="300" height="350">
              <font color="red"> <h1>KPL SHUDHI COCONUT OIL 500 ML</h1> </font>
              <h2>&#x20B9; 122.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Hair Oil & Coconut Oil/3.jpeg" width="300" height="350">
              <font color="red"> <h1>PARACHUTE 100% COCONUT OIL 100 ML</h1> </font>
              <h2>&#x20B9; 33.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Hair Oil & Coconut Oil/4.jpeg" width="300" height="350"></a>
            <font color="red"> <h1>PARACHUTE 100% PURE COCONUT OIL 500ML</h1> </font>
            <h2>&#x20B9; 195.00</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Hair Oil & Coconut Oil/5.png" width="300" height="350">
              <font color="red"> <h1>VVD GOLD COCONUT OIL 100 ML POUCH</h1> </font>
              <h2>&#x20B9; 31.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Hair Oil & Coconut Oil/6.jpeg" width="300" height="350">
              <font color="red"> <h1>VVD GOLD COCONUT OIL 500 ML</h1> </font>
              <h2>&#x20B9; 194.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
