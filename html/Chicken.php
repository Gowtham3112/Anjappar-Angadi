...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Chicken.php">Chicken</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/Chicken/1.jpeg" width="390" height="250"></a>
            <font color="red"> <h1>BONE CURRY CUT (40GM EACH PC) 1 KG</h1> </font>
            <h2>&#x20B9; 230.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/Chicken/2.jpeg" width="390" height="250">
              <font color="red"> <h1>BONELESS BREAST MEAT 500GM</h1> </font>
              <h2>&#x20B9; 250.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/Chicken/3.jpeg" width="390" height="250">
              <font color="red"> <h1>BONELESS CURRY CUT 500 GRAM</h1> </font>
              <h2>&#x20B9; 250.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/Chicken/4.jpeg" width="390" height="250"></a>
            <font color="red"> <h1>BONESS THIGH MEAT 500GM</h1> </font>
            <h2>&#x20B9; 225.00</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/Chicken/5.jpeg" width="390" height="250">
              <font color="red"> <h1>CHICKEN LEQ QUARTER 1KG</h1> </font>
              <h2>&#x20B9; 400.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/Chicken/6.jpeg" width="390" height="250">
              <font color="red"> <h1>CHICKEN LIVER 1KG/h1> </font>
              <h2>&#x20B9; 200.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/Chicken/7.jpeg" width="390" height="250"></a>
            <font color="red"> <h1>CHICKEN WHOLE 1.2 GM</h1> </font>
            <h2>&#x20B9; 250.00</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/Chicken/8.jpeg" width="390" height="250">
              <font color="red"> <h1>CHICKEN WINGS 500 GM</h1> </font>
              <h2>&#x20B9; 350.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
