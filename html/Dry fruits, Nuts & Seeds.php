...
<html>
    <head>
    <title>Dry fruits,Nuts & Seeds</title>
    ...
    <link rel="stylesheet" href="../css/Dry fruits, Nuts & Seeds.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Dry fruits, Nuts & Seeds.php">Dry fruits,Nuts & Seeds</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Dry fruits, Nuts & Seeds/1.png" width="300" height="350">
            <font color="red"> <h1>AA-BADAM 100GM</h1> </font>
            <h2>&#x20B9; 84.50</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Dry fruits, Nuts & Seeds/2.png" width="300" height="350">
              <font color="red"> <h1>AA-CASHEW SPLIT 100G</h1> </font>
              <h2>&#x20B9; 68.90</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Dry fruits, Nuts & Seeds/3.png" width="300" height="350">
              <font color="red"> <h1>AA-CASHEW WHOLE 100 GM</h1> </font>
              <h2>&#x20B9; 91.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="row">
            <div class="column">
              <div class="card">
                 <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Dry fruits, Nuts & Seeds/4.jpeg" width="300" height="350">
                <font color="red"> <h1>AA-PISTA 100GM</h1> </font>
                <h2>&#x20B9; 169.00</h2>
                 <br>
              <p><button>Add to Cart</button></p>
                </div>
