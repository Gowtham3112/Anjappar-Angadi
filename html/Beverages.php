...
<html>
      ...
      <header class="header">
        ...
        <div class="header-1">
            ...
            <div class="icons">
                ...
                <a href="../html/login.pho" class="fas fa-user"></a>
    ...
    <div class="header-3">
        <nav class="navbar">
          <a href="../html/Beverages.php">Beverages</a>
        </nav>
      </div>
      </header>
      ...
      <div class="fullscreen">
        ...
        <div class="Coloumpadding">
            <div class="column1">
                <div class="card1">
                  <a href="../html/Tea & Coffee.php">
                  <h3 style="color:rgb(223, 16, 16);">Tea & Coffee</h3></a>
              ...
              <div class="column1">
                <div class="card1" >
                        <a href="../html/Health Drinks.php">
                  <h3 style="color:rgb(223, 16, 16);">Health Drinks</h3></a>
              ...
              <div class="column1">
                <div class="card1">
                  <a href="#">
                  <h3 style="color:rgb(223, 16, 16);">Cool Drinks</h3></a>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
            <a href="../html/Tea & Coffee.php">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Beverages/1.jpeg" width="350" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="../html/Health Drinks.php">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Beverages/2.jpeg" width="350" height="250"></a>
            </div>
        </div>
      ...
      <div class="column">
          <div class="card">
            <a href="">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Beverages/3.jpg" width="350" height="250"></a>
            </div>
        </div>
      </div>
      </div>
