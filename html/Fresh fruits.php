...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Fresh fruits.php">Fresh Fruits</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/1.jpeg" width="390" height="250"></a>
            <font color="red"> <h1>Apple 1KG</h1> </font>
            <h2>&#x20B9; 250.00</h2>
            <div class="card">
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/2.jpeg" width="390" height="250">
              <font color="red"> <h1>BANANA-NENTHIRAM 1 KG</h1> </font>
              <h2>&#x20B9; 65.00</h2>
              <div class="card">
                <p><button>Add to Cart</button></p>
              </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/3.jpeg" width="390" height="250">
              <font color="red"> <h1>BANANA-RED 1 KG</h1> </font>
              <h2>&#x20B9; 80.00</h2>
              <div class="card">
                <p><button>Add to Cart</button></p>
              </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/4.jpeg" width="390" height="250"></a>
            <font color="red"> <h1>BANANA-YELAKKI 1 KG</h1> </font>
            <h2>&#x20B9; 69.00</h2>
             <div class="card">
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/5.jpeg" width="390" height="250">
              <font color="red"> <h1>FIG 1 KG</h1> </font>
              <h2>&#x20B9; 99.00</h2>
              <div class="card">
                <p><button>Add to Cart</button></p>
              </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/6.jpeg" width="390" height="250">
              <font color="red"> <h1>GRAPES-GREEN 1 KG</h1> </font>
              <h2>&#x20B9; 79.00</h2>
              <div class="card">
                <p><button>Add to Cart</button></p>
              </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/7.jpeg" width="390" height="250"></a>
            <font color="red"> <h1> MOSAMBI 1 KG</h1> </font>
            <h2>&#x20B9; 69.00</h2>
            <div class="card">
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/8.png" width="390" height="250">
              <font color="red"> <h1>MUSKMELON 1 KG</h1> </font>
              <h2>&#x20B9; 45.00</h2>
              <div class="card">
                <p><button>Add to Cart</button></p>
              </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/9.jpeg" width="390" height="250">
              <font color="red"> <h1>ORANGE 1 KG</h1> </font>
              <h2>&#x20B9; 79.00</h2>
              <div class="card">
                <p><button>Add to Cart</button></p>
              </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/10.jpeg" width="390" height="250"></a>
            <font color="red"> <h1> PAPAYA 1 KG</h1> </font>
            <h2>&#x20B9; 39.00</h2>
            <div class="card">
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/11.jpeg" width="390" height="250">
              <font color="red"> <h1>PINEAPPLE 1 KG</h1> </font>
              <h2>&#x20B9; 69.00</h2>
              <div class="card">
                <p><button>Add to Cart</button></p>
              </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Fresh Fruits/12.jpeg" width="390" height="250">
              <font color="red"> <h1>POMEGRANATE 1 KG</h1> </font>
              <h2>&#x20B9; 160.00</h2>
              <div class="card">
                <p><button>Add to Cart</button></p>
              </div>
