...
<html>
    ...
    <link rel="stylesheet" href="../css/Rice Products.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Rice Products.php">Rice Products</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Rice Products/1.png" width="300" height="350"></a>
            <font color="red"> <h1>AA-IDLY RICE 1KG</h1> </font>
            <h2>&#x20B9; 42.00</h2>
            <h2>&#x20B9; 197.00</h2>
              <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Rice Products/2.png" width="300" height="350">
              <font color="red"> <h1>AA-PONNI BOILED RICE 1KG</h1> </font>
              <h2>&#x20B9; 52.00</h2>
              <h2>&#x20B9; 197.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Rice Products/3.png" width="300" height="350">
              <font color="red"> <h1>AA-PONNI RAW RICE 1KG</h1> </font>
              <h2>&#x20B9; 52.00</h2>
              <h2>&#x20B9; 197.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
        ...
        <div class="row">
            <div class="column">
              <div class="card">
                 <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Rice Products/4.jpeg" width="300" height="350">
                <font color="red"> <h1>INDIA GATE BASMATHI RICE ROZANA 1 KG</h1> </font>
                <h2>&#x20B9; 96.00</h2>
                <h2>&#x20B9; 197.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            ...
            <div class="column">
              <div class="card">
                  <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Rice Products/5.jpeg" width="300" height="350">
                  <font color="red"> <h1>INDIA GATE BASMATI RICE DUBAR 1 KG</h1> </font>
                  <h2>&#x20B9; 82.00</h2>
                  <h2>&#x20B9; 197.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            ...
            <div class="column">
              <div class="card">
                  <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Rice Products/6.jpeg" width="300" height="350">
                  <font color="red"> <h1>INDIA GATE BASMATI RICE SUPER 1 KG</h1> </font>
                  <h2>&#x20B9; 164.40</h2>
                  <h2>&#x20B9; 197.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
