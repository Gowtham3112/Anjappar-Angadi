...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/Milk/1.jpeg" width="390" height="250"></a>
            <font color="red"> <h1>Aavin Diet (Double Toned Milk) - 500 ml</h1> </font>
            <h2>&#x20B9; 20.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/Milk/2.jpeg" width="390" height="250">
              <font color="red"> <h1>Aavin Green Magic (Standardized Milk) 225 ml</h1> </font>
              <h2>&#x20B9; 11.50</h2>
              <br>
            <p><button>Add to Cart</button></p>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/Milk/3.jpeg" width="390" height="250">
              <font color="red"> <h1>Aavin Green Magic (Standardized Milk) 500 ml</h1> </font>
              <h2>&#x20B9; 23.50</h2>
              <br>
            <p><button>Add to Cart</button></p>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/Milk/4.jpeg" width="390" height="250"></a>
            <font color="red"> <h1>Aavin Green Magic (Standardized Milk) 5L</h1> </font>
            <h2>&#x20B9; 225.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/Milk/5.jpeg" width="390" height="250">
              <font color="red"> <h1>Aavin Green Magic (Standardized Milk) 1L</h1> </font>
              <h2>&#x20B9; 43.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/Milk/6.jpeg" width="390" height="250">
              <font color="red"> <h1>Aavin Nice (Toned Milk) 500 ml</h1> </font>
              <h2>&#x20B9; 21.10</h2>
              <br>
            <p><button>Add to Cart</button></p>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/Milk/7.jpeg" width="390" height="250"></a>
            <font color="red"> <h1> Aavin Premium (Full Cream Milk) 500 ml</h1> </font>
            <h2>&#x20B9; 25.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
