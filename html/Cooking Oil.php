...
<html>
    ...
    <link rel="stylesheet" href="../css/Cooking oil.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Cooking Oil.php">Cooking Oil</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Cooking Oil/1.jpeg" width="300" height="330">
            <font color="red"> <h1>FORTUNE REFINED SUNFLOWER OIL 1 LTR </h1> </font>
            <h2>&#x20B9; 134.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Cooking Oil/2.jpeg" width="300" height="330">
              <font color="red"> <h1>FORTUNE REFINED SUNFLOWER OIL 5 LTR</h1> </font>
              <h2>&#x20B9; 735.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Cooking Oil/3.png" width="300" height="330">
              <font color="red"> <h1>GOLD WINNER REFINED SUNFLOWER OIL 1 LTR</h1> </font>
              <h2>&#x20B9; 138.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Cooking Oil/4.jpeg" width="300" height="330"></a>
            <font color="red"> <h1>GOLD WINNER REFINED SUNFLOWER OIL 500 ML</h1> </font>
            <h2>&#x20B9; 66.00</h2>
             <<br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Cooking Oil/5.jpeg" width="350" height="330">
              <font color="red"> <h1>GOLD WINNER REFINED SUNFLOWER OIL 5L CAN</h1> </font>
              <h2>&#x20B9; 668.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Cooking Oil/6.jpeg" width="350" height="330">
              <font color="red"> <h1>IDHAYAM GINGELLY OIL 1 LTR POUCH</h1> </font>
              <h2>&#x20B9; 284.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Cooking Oil/7.jpeg" width="350" height="330"></a>
            <font color="red"> <h1>IDHAYAM GINGELLY OIL 200 ML POUCH</h1> </font>
            <h2>&#x20B9; 61.00</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Cooking Oil/8.jpeg" width="350" height="330">
              <font color="red"> <h1>IDHAYAM GINGELLY OIL 500 ML POUCH</h1> </font>
              <h2>&#x20B9; 151.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Cooking Oil/9.jpeg" width="350" height="330">
              <font color="red"> <h1>SAFFOLA TASTY LOSORB TECHNOLOGY 1 LTR</h1> </font>
              <h2>&#x20B9; 119.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
