<html>
    ...
    <link rel="stylesheet" href="../css/Fish  Sea Foods.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Fish  Sea Foods.php">Fish Sea Foods</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Fish  Sea Foods/1.jpeg" width="350" height="250"></a>
            <font color="red"> <h1>Prawns 65 500 GRAM</h1> </font>
            <h2>&#x20B9; 450.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Fish  Sea Foods/2.jpeg" width="350" height="250">
              <font color="red"> <h1>VANJARAM FINGER FISH 500g</h1> </font>
              <h2>&#x20B9; 400.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Fish  Sea Foods/3.jpeg" width="350" height="250">
              <font color="red"> <h1>VANJARAM FISH 65 500 GRAM</h1> </font>
              <h2>&#x20B9; 500.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Fish  Sea Foods/4.jpeg" width="350" height="250"></a>
            <font color="red"> <h1>Whole pomfret thava fry 500 GRAM</h1> </font>
            <h2>&#x20B9; 400.00</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Fish  Sea Foods/5.jpeg" width="350" height="250">
              <font color="red"> <h1>Whole pomfret thava fry 750 GRAM</h1> </font>
              <h2>&#x20B9; 700.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
