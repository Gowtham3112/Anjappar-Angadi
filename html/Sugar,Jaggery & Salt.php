...
<html>
    <head>
    <title>Sugar,Jaggery & Salt</title>
    ...
    <link rel="stylesheet" href="../css/Sugar,Jaggery & Salt.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Sugar,Jaggery & Salt.php">Sugar,Jaggery & Salt</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Sugar,Jaggery & Salt/1.png" width="300" height="350"></a>
            <font color="red"> <h1>AA-SUGAR 1KG</h1> </font>
            <h2>&#x20B9; 52.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Sugar,Jaggery & Salt/2.jpeg" width="300" height="350">
              <font color="red"> <h1>TATA SALT 1 KG</h1> </font>
              <h2>&#x20B9; 18.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
