...
<html>
    ...
    <link rel="stylesheet" href="../css/Atta, Flours & Sooji.css">
    ...
    <div class="header-3">
        <nav class="navbar">
          <a href="../html/Atta, Flours & Sooji.php">Atta, Flours & Sooji</a>
        </nav>
      </div>
      </header>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Atta, Flours & Sooji/1.png" width="390" height="380"></a>
            <font color="red"> <h1>ANIL LEMON ROASTED SHORT VERMICELLI 200 GM</h1> </font>
            <h2>&#x20B9; 22.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Atta, Flours & Sooji/2.jpeg" width="390" height="390">
              <font color="red"> <h1>ANIL RAGI VERMICELLI 180GM</h1> </font>
              <h2>&#x20B9; 20.00</h2>
              <br>
              <br>
              <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Atta, Flours & Sooji/3.jpeg" width="390" height="390">
              <font color="red"> <h1>ANIL ROASTED SHORT VERMICELLI 450GM</h1> </font>
              <h2>&#x20B9; 40.00</h2>
              <br>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Atta, Flours & Sooji/4.jpeg" width="390" height="390"></a>
            <font color="red"> <h1>ANIL STRING HOPPER FLOUR(IDIYAPPAM) 500G</h1> </font>
            <h2>&#x20B9; 38.00</h2>
             <br>
             <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Atta, Flours & Sooji/5.jpeg" width="390" height="390">
              <font color="red"> <h1>ANIL TAMARIND ROASTED SHORT VERMICELLI 200 GMS</h1> </font>
              <h2>&#x20B9; 22.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Atta, Flours & Sooji/6.jpeg" width="300" height="390">
              <font color="red"> <h1>NARASU'S RAVA 1 KG</h1> </font>
              <h2>&#x20B9; 65.00</h2>
              <br>
              <br>
              <br>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Atta, Flours & Sooji/7.jpeg" width="300" height="390"></a>
            <font color="red"> <h1>NARASU'S SOOJI 1 KG</h1> </font>
            <h2>&#x20B9; 64.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Atta, Flours & Sooji/8.jpeg" width="300" height="390">
              <font color="red"> <h1>NARASU'S ATTA 1 KG</h1> </font>
              <h2>&#x20B9; 52.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/Atta, Flours & Sooji/9.jpeg" width="300" height="390">
              <font color="red"> <h1>NARASU'S MAIDA 1 KG</h1> </font>
              <h2>&#x20B9; 31.00</h2>
              <br>
