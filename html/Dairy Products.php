...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Dairy Products.php">Daily Products</a>
</nav>
</div>
</header>
...
<div class="column1">
    <div class="card1">
      <a href="../html/Aavin.php">
      <h3 style="color:rgb(223, 16, 16);">Aavin</h3></a>
  ...
  <div class="column1">
    <div class="card1" >
      <a href="../html/Ghee All Brands.php">
      <h3 style="color:rgb(223, 16, 16);">Ghee All Brands</h3></a>
  ...
  <div class="column1">
    <div class="card1">
      <a href="../html/Nandini.php">
      <h3 style="color:rgb(223, 16, 16);">Nandini</h3></a>
  ...
  <div class="row">
    <div class="column">
      <div class="card">
        <a href="../html/Aavin.php">
          <img border="0" alt="W3Schools" src="../Images/Dairy Products\aavin.jpeg" width="390" height="250"></a>
      </div>
    </div>
    ...
    <div class="column">
      <div class="card">
        <a href="../html/Ghee All Brands.php">
          <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee.jpeg" width="390" height="250"></a>
      </div>
    </div>
    ...
    <div class="column">
      <div class="card">
        <a href="../html/Nandini.php">
          <img border="0" alt="W3Schools" src="../Images/Dairy Products/Nandini.jpeg" width="390" height="250"></a>
      </div>
    </div>
  </div>
</div>  
