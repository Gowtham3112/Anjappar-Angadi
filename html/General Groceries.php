...
<html>
    ...
    <link rel="stylesheet" href="../css/General Groceries.css">
    ...
    <div class="header-3">
        <nav class="navbar">
          <a href="../html/General Groceries.php">General Groceries</a>
        </nav>
      </div>
      </header>
      ...
      <div class="fullscreen">
        ...
        <div class="Coloumpadding">
            <div class="column1">
                <div class="card1">
                  <a href="../html/Essential Products.php">
                  <h3 style="color:rgb(223, 16, 16);">Essential Products</h3></a>
                </div>
              </div>
              
              <div class="column1">
                <div class="card1" >
                        <a href="../html/Papads-Ready-to-Fry.php">
                  <h3 style="color:rgb(223, 16, 16);">Papads-Ready-to-Fry</h3></a>
                </div>
              </div>
              ...
              <div class="column1">
                <div class="card1" >
                        <a href="#">
                  <h3 style="color:rgb(223, 16, 16);">Healthy Food</h3></a>
                </div>
              </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
            <a href="../html/Essential Products.php">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/1.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="../html/Papads-Ready-to-Fry.php">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/2.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/3.jpg" width="390" height="250"></a>
            </div>
        </div>
      </div>
      </div>
