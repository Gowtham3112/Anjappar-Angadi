...
<html>
    ...
    <link rel="stylesheet" href="../css/Pooja Oil.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Pooja Oil.php">Pooja Oil</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Pooja Oil/1.jpeg" width="320" height="300"></a>
            <font color="red"> <h1>DEEPAM LAMP POOJA OIL 500 ML</h1> </font>
            <h2>&#x20B9; 83.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Pooja Oil/2.jpeg" width="300" height="310">
              <font color="red"> <h1>DEEPAM LAMP POOJA OIL 1000 ML</h1> </font>
              <h2>&#x20B9; 160.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/Pooja Oil/3.jpeg" width="320" height="300">
              <font color="red"> <h1>DEEPAM LAMP POOJA OIL 250 ML</h1> </font>
              <h2>&#x20B9; 59.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
