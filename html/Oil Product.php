...
<html>
    ...
    <link rel="stylesheet" href="../css/Oil Product.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Oil Product.php">Oil Products</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
        ...
        <div class="Coloumpadding">
            <div class="column1">
                <div class="card1">
                  <a href="../html/Hair Oil & Coconut Oil.php">
                  <h3 style="color:rgb(223, 16, 16);">Hair oil & Coconur oil</h3></a>
              ...
              <div class="column1">
                <div class="card1" >
                        <a href="../html/Cooking Oil.php">
                  <h3 style="color:rgb(223, 16, 16);">Cooking Oil</h3></a>
              ...
              <div class="column1">
                <div class="card1">
                  <a href="../html/Pooja Oil.php">
                  <h3 style="color:rgb(223, 16, 16);">Pooja  Oil</h3></a>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
            <a href="../html/Hair Oil & Coconut Oil.php">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/1.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="../html/Cooking Oil.php">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/2.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="../html/Pooja Oil.php">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/oil Product/3.jpeg" width="390" height="250"></a>
            </div>
        </div>
      </div>
        </div>
