...
<html>
    ...
    <link rel="stylesheet" href="../css/Ghee All Brands.css">
    ...
    <div class="header-3">
        <nav class="navbar">
          <a href="../html/Ghee All Brands.php">Ghee all Brands</a>
        </nav>
      </div>
      </header>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/1.jpeg" width="390" height="350"></a>
            <font color="red"> <h1>Aavin Ghee 200ml</h1> </font>
            <h2>&#x20B9; 114.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/2.jpeg" width="390" height="350">
              <font color="red"> <h1>Aavin Ghee 500ml</h1> </font>
              <h2>&#x20B9; 263.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/3.jpeg" width="390" height="350">
              <font color="red"> <h1>AGMARK GHEE 1LTR</h1> </font>
              <h2>&#x20B9; 609.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/4.jpeg" width="390" height="350"></a>
            <font color="red"> <h1>AGMARK GHEE 500ML</h1> </font>
            <h2>&#x20B9; 328.00</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/5.jpeg" width="390" height="350">
              <font color="red"> <h1>FRESHEYS ORGANIC 500ML</h1> </font>
              <h2>&#x20B9; 593.76</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/6.jpeg" width="390" height="350">
              <font color="red"> <h1>GRB 100ML</h1> </font>
              <h2>&#x20B9; 593.76</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/7.jpeg" width="390" height="350"></a>
            <font color="red"> <h1>GRB 500ML</h1> </font>
            <h2>&#x20B9; 593.76</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/8.jpeg" width="390" height="350">
              <font color="red"> <h1>GRB 50ML</h1> </font>
              <h2>&#x20B9; 593.76</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/9.jpeg"  width="390" height="350">
              <font color="red"> <h1>RKG 1LTR</h1> </font>
            <h2>&#x20B9; 593.76</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/10.jpeg" width="390" height="350"></a>
            <font color="red"> <h1> RKG 200ML</h1> </font>
            <h2>&#x20B9; 593.76</h2>
            <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/11.jpeg" width="390" height="350">
              <font color="red"> <h1>RKG 500ML</h1> </font>
              <h2>&#x20B9; 593.76</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Ghee All Brands/12.jpeg" width="390" height="350">
              <font color="red"> <h1>TIRUMALA GHEE 1 LTR</h1> </font>
              <h2>&#x20B9; 593.76</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
