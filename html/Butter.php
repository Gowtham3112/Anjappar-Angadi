...
<html>
    ...
    <div class="header-3">
        <nav class="navbar">
          <a href="../html/Butter.php">Butter</a>
        </nav>
      </div>
      </header>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/Butter/1.jpeg" width="350" height="250"></a>
            <font color="red"> <h1>Aavin Cooking Butter 100g</h1> </font>
            <h2>&#x20B9; 52.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/Butter/2.jpeg" width="350" height="250">
              <font color="red"> <h1>Aavin Cooking Butter 500g</h1> </font>
              <h2>&#x20B9; 250.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
