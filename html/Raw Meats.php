...
<html>
    ...
    <link rel="stylesheet" href="../css/Raw Meats.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Raw Meats.php">Raw Meats</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
        ...
        <div class="Coloumpadding">
            <div class="column1">
                <div class="card1">
                  <a href="../html/Goat Lamb.php">
                  <h3 style="color:rgb(223, 16, 16);">Goat / Lamb</h3></a>
              ...
              <div class="column1">
                <div class="card1" >
                        <a href="../html/Chicken.php">
                  <h3 style="color:rgb(223, 16, 16);">Chicken</h3></a>
              ...
              <div class="column1">
                <div class="card1" >
                        <a href="">
                  <h3 style="color:rgb(223, 16, 16);">Naatu kohli</h3></a>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
            <a href="../html/Goat Lamb.php">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/1.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="../html/Chicken.php">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/2.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Raw Meats/3.jpg" width="390" height="250"></a>
            </div>
        </div>
      </div>
        </div>
