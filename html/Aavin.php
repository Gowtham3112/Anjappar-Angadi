...
<html>
    ...
    <link rel="stylesheet" href="../css/Aavin.css">
    ...
    <div class="header-3">
      ...
      <div class="fullscreen">
        ...
        <div class="Coloumpadding">
            <div class="column1">
                <div class="card1">
                  <a href="../html/Milk.php">
                  <h3 style="color:rgb(223, 16, 16);">Milk</h3></a>
              ...
              <div class="column1">
                <div class="card1" >
                  ...
                  <h3 style="color:rgb(223, 16, 16);">Sweet</h3></a>
              ...
              <div class="column1">
                <div class="card1">
                  <a href="../html/Fermented Products.php">
                  <h3 style="color:rgb(223, 16, 16);">Fermented Products</h3></a>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
            <a href="../html/Milk.php">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/1.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="../html/Sweet.php">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/2.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="../html/Fermented Products.php">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/3.jpeg" width="390" height="250"></a>
            </div>
        </div>
      </div>
      ...
      <div class="column1">
        <div class="card1">
          <a href="../html/Butter.php">
          <h3 style="color:rgb(223, 16, 16);">Butter</h3></a>
      ...
      <div class="column1">
        <div class="card1" >
                <a href="../html/Ghee.php">
          <h3 style="color:rgb(223, 16, 16);">Ghee</h3></a>
        </div>
      </div>
      ...
      <div class="column1">
        <div class="card1" >
                <a href="">
          <h3 style="color:rgb(223, 16, 16);">Milk Bread</h3></a>
        </div>
      </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
            <a href="../html/Butter.php">
             <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/4.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="../html/Ghee.php">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/6.jpeg" width="390" height="250"></a>
            </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <a href="">
              <img border="0" alt="W3Schools" src="../Images/Dairy Products/Aavin/5.jpg" width="390" height="250"></a>
            </div>
        </div>
        </div>
        </div>
