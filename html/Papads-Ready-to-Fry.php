<html>
    <head>
    <title>Papadas-Ready-to-Fry</title>
    ...
    <link rel="stylesheet" href="../css/Papads-Ready-to-Fry.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Papads-Ready-to-Fry.php">Papads-Ready-to-Fry</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/1.png" width="340" height="250"></a>
            <font color="red"> <h1>AMBIKA APPALAM DEPOT NO-7 70 GMS</h1> </font>
            <h2>&#x20B9; 39.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/1.png" width="340" height="250">
              <font color="red"> <h1>AMBIKA APPALAM NO-1 325 GMS</h1> </font>
              <h2>&#x20B9; 155.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/1.png" width="340" height="250">
              <font color="red"> <h1>AMBIKA APPALAM NO-2 285GMS</h1> </font>
              <h2>&#x20B9; 135.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/1.png" width="340" height="250"></a>
            <font color="red"> <h1>AMBIKA APPALAM NO-3 255GMS</h1> </font>
            <h2>&#x20B9; 116.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/1.png" width="340" height="250">
              <font color="red"> <h1>AMBIKA APPALAM NO-4 180GMS</h1> </font>
              <h2>&#x20B9; 97.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/1.png" width="340" height="250">
              <font color="red"> <h1>AMBIKA APPALAM NO-5 150GMS</h1> </font>
              <h2>&#x20B9; 105.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/1.png" width="340" height="250"></a>
            <font color="red"> <h1>AMBIKA APPALAM NO-6 100GMS</h1> </font>
            <h2>&#x20B9; 58.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/1.png" width="340" height="250">
              <font color="red"> <h1>AMBIKA SPECIAL APPALAM 375 GMS/h1> </font>
              <h2>&#x20B9; 174.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/2.jpeg" width="340" height="250">
              <font color="red"> <h1>BINDU APPALAM 100GMS</h1> </font>
              <h2>&#x20B9; 57.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/2.jpeg" width="340" height="250"></a>
            <font color="red"> <h1>BINDU APPALAM MINI 100GMS</h1> </font>
            <h2>&#x20B9; 57.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/2.jpeg" width="340" height="250">
              <font color="red"> <h1>BINDU APPALAM SIMPLY SUPER 70 GMS</h1> </font>
              <h2>&#x20B9; 40.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/2.jpeg" width="340" height="250">
              <font color="red"> <h1>BINDU APPALAMS 159GMS</h1> </font>
              <h2>&#x20B9; 78.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/3.jpeg" width="340" height="250"></a>
            <font color="red"> <h1>POPULAR APPALAM 100 GMS</h1> </font>
            <h2>&#x20B9; 48.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/3.jpeg" width="340" height="250">
              <font color="red"> <h1>POPULAR APPALAM 70 GMS</h1> </font>
              <h2>&#x20B9; 38.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Groceries & Vegetables/General Groceries/Papads-Ready-To-Fry/3.jpeg" width="340" height="250">
              <font color="red"> <h1>POPULAR APPALAMS 200 GMS</h1> </font>
              <h2>&#x20B9; 101.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
