<html>
    <head>
    <title>Chicken For Deep Fried</title>
    ...
    <link rel="stylesheet" href="../css/Chicken For Deep Fried.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Chicken For Deep Fried.php">Chicken For Deep Fried</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Chicken For Deep Fried/1.jpeg" width="350" height="250"></a>
            <font color="red"> <h1>CHICKEN 65-BONELESS 1 KG</h1> </font>
            <h2>&#x20B9; 375.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Chicken For Deep Fried/2.jpeg" width="350" height="250">
              <font color="red"> <h1>CHICKEN LOLLIPOP 1 KG</h1> </font>
              <h2>&#x20B9; 350.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Chicken For Deep Fried/3.jpeg" width="350" height="250">
              <font color="red"> <h1>FRIED CHICKEN FULL CHICKEN 1 </h1> </font>
              <h2>&#x20B9; 300.00</h2>
              <br>
              <p><button>Add to Cart</button></p>
            </div>
