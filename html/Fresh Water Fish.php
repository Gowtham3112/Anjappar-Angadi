<html>
    ...
    <link rel="stylesheet" href="../css/Fresh Water Fish.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Fresh Water Fish.php">Fresh Water Fish</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Fresh Water Fish/1.jpeg" width="350" height="250"></a>
            <font color="red"> <h1>Crab meat 250 GM</h1> </font>
            <h2>&#x20B9; 600.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Fresh Water Fish/2.jpeg" width="350" height="250">
              <font color="red"> <h1>Jilebi kentai 500 gm</h1> </font>
              <h2>&#x20B9; 350.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Fresh Water Fish/3.png" width="350" height="250">
              <font color="red"> <h1>Katla fish 1KG</h1> </font>
              <h2>&#x20B9; 400.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Fresh Water Fish/4.jpeg" width="350" height="250"></a>
            <font color="red"> <h1>Mud crab 500GM</h1> </font>
            <h2>&#x20B9; 250.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Fresh Water Fish/5.jpeg" width="350" height="250">
              <font color="red"> <h1>MURREL FISH/VIRAL FISH </h1> </font>
              <h2>&#x20B9; 400.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Fresh Water Fish/6.jpeg" width="350" height="250">
              <font color="red"> <h1>Rogu Fish 1 KG</h1> </font>
              <h2>&#x20B9; 300.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
