<html>
    ...
    <link rel="stylesheet" href="../css/Oven Cooking.css">
...
<div class="header-3">
<nav class="navbar">
  <a href="../html/Oven Cooking.php">Oven Cooking</a>
</nav>
</div>
</header>
...
<div Class="sidebar">
  ...
  <h1><li> <a href="#">Diwali Deals</a></li></h1>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Oven Cooking/1.jpeg" width="350" height="250"></a>
            <font color="red"> <h1>Bar-be-cue chicken 500gm</h1> </font>
            <h2>&#x20B9; 250.00</h2>
            <br>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Oven Cooking/2.jpeg" width="350" height="250">
              <font color="red"> <h1>CHICKEN TIKKA MARINATED</h1> </font>
              <h2>&#x20B9; 300.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Oven Cooking/3.jpeg" width="350" height="250">
              <font color="red"> <h1>GRILL CHICKEN 1KG</h1> </font>
              <h2>&#x20B9; 350.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Oven Cooking/4.jpeg" width="350" height="250"></a>
            <font color="red"> <h1>TANDOORI CHICKEN 1 KG</h1> </font>
            <h2>&#x20B9; 330.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Oven Cooking/5.jpeg" width="350" height="250">
              <font color="red"> <h1>TANDOORI CHICKEN 500</h1> </font>
              <h2>&#x20B9; 185.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
        ...
        <div class="column">
          <div class="card">
              <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Oven Cooking/6.jpeg" width="350" height="250">
              <font color="red"> <h1>TANGDI KEBAB 250 GM</h1> </font>
              <h2>&#x20B9; 200.00</h2>
              <br>
            <p><button>Add to Cart</button></p>
            </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
             <img border="0" alt="W3Schools" src="../Images/Meats & Marinates/Marinated Meats/Oven Cooking/7.jpeg" width="350" height="250"></a>
            <font color="red"> <h1>THAVA CHICKEN 500 GM</h1> </font>
            <h2>&#x20B9; 250.00</h2>
            <br>
            <p><button>Add to Cart</button></p>
            </div>
