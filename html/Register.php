...
<html>
    <head>
    <title>Groceries & Vegetables</title>
...
<a href="https://mail.google.com/mail/&ogbl" class="google"> <img src="../Images/googlr.png" width="260" height="40"> </a><br>
<a href="https://www.facebook.com/login/" class="fb"> <img src="../Images/fb.jpg" width="260" height="50"> </a><br>
<br>
<br>
<br>
<br>
        ...
        <form action="reg.php" method="post">
          ...
          <div class="container-2">
            ...
            <TABLE>
              ...
              Email: </td> 
              <td><input  type="text"  input id="email" name="email" required> *</td>
            </tr>

            <tr>
               <td style="text-align: right;">
              Phone: </td>
              <td> <input type="text" input id="phone" name="phone" required > *</td>
            </tr>
               
            <tr>
              <td style="text-align: right;">
              Username: </td>
              <td><input  type="text" input id="username" name="username" required> *</td> 
            </tr>
           ...
           <hr>
              <tr>
                <td style="text-align: right;">
              Password: </td>
              <td> <input  type="password" input id="password" name="password" required> *</td>
            </tr>
          ...
          <br>
             <h2> <input type="checkbox"  name="remember"> I accept privacy policy </h2>
